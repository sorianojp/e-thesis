                ...
                <form method="POST" action="{{ route('theses.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="mb-2">
                            ...
                            @if ($advisers->isEmpty())
                                <p class="text-xs text-gray-500 mt-1">No advisers available yet. Please contact an administrator.</p>
                            @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="mb-2">
                            ...
                            <input id="endorsement_pdf" type="file" name="endorsement_pdf" accept="application/pdf,.pdf"
                                class="mt-1 block w-full" required />
